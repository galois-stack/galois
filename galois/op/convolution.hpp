...
public:
    ...
    std::shared_ptr<ir::TensorType> InferType(
        ...
        GALOIS_ASSERT(input_type->shape[0] == weight_type->shape[1]); // input_channels == weight_input_channels
    ...
    void ExpressInline(std::vector<std::shared_ptr<ir::Tensor>> ir_inputs,
        ...
        // Create (2N+2)-dimensional grid: [out_c, out_d1, out_d2, ..., out_dn, k1, k2, ..., kn, in_c]
